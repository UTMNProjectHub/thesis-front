...
import { useSessionSubmits, useSessions } from '@/entities/session'
import QuizResultView from '@/widgets/quiz-result-view/QuizResultView'
import QuizResultSessionSelector from '@/widgets/quiz-result-session-selector/QuizResultSessionSelector'
